...
#TACV attacks
from .attacks.dm import DistortionMinimizingAttack
from .attacks.lm import LossMaximizingAttack
from .attacks.uav import UniversalAdversarialAttack
from .attacks.ulsa import UniversalLatentSpaceAttack
from .attacks.bb import BlackBoxTransferAttack
...
__all__ = [
    ...
    "MultiAttack",
    "LGV",
    "DistortionMinimizingAttack",
    "LossMaximizingAttack",
    "UniversalAdversarialAttack",
    "UniversalLatentSpaceAttack",
    "BlackBoxTransferAttack",
]
__wrapper__ = [
    "LGV",
    "MultiAttack",
